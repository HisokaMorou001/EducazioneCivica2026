...
// --- AVVIO SCENA ---
function avviaScene() {
    document.body.style.backgroundImage = "url('immagini/dialogo_6.png')";
    resizeBackground();

    frasi = [
        `Ciao. Mi dispiace per quello che' successo… posso dirti cio' che ho visto.`,
        `Ho sentito qualcuno ridere vicino agli armadietti, una risata un po’… arrogante.`,
        `Quando mi sono avvicinata, ho visto una figura con una borsa da palestra.`,
        `E quella borsa… la porta sempre Manami Okuda.`
    ];

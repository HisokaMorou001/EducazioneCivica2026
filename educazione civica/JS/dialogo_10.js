...
// --- AVVIO SCENA ---
function avviaScene() {
    document.body.style.backgroundImage = "url('immagini/dialogo_10.png')";
    resizeBackground();


    frasi = [
        'Ho visto qualcuno spruzzare la schiuma.',
        'Si muoveva in modo atletico.',
        'Ma oggi molti si allenavano.',
        'Potrei aver confuso la persona.'
    ];

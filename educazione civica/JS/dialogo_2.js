...
// --- AVVIO SCENA ---
function avviaScene() {
    document.body.style.backgroundImage = "url('immagini/dialogo_2.png')";
    resizeBackground();

    frasi = [
        `Oh, detective! Finalmente qualcuno che vuole fare chiarezza. Io so già chi e' stato, fidati.`,
        `Secondo me e' stato Tomohito Sugino. Lui e' sempre in giro presto, potrebbe averlo fatto senza problemi.`,
        `E poi… chi altro potrebbe avere tempo per certe stupidaggini? Sicuro una persona super precisa come lui.`,
        `Io ti dico: punta tutto su Tomohito. E' ovvio, no?`
    ];

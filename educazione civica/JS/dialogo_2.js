...
function avviaScene() {
    ...
    frasi = [
        "Non ero vicino agli armadietti, questo e' sicuro.",
        "Pero' ho visto qualcuno correre verso la palestra.",
        "Non era sola... o almeno mi e' sembrato così.",
        "Potrei confondermi, c'era molta gente."
    ];
